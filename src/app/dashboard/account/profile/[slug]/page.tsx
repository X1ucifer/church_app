...
function UserProfile( { params }: any) {
    ...
    const handleEdit = () => {
        ...
        router.push(`/dashboard/member/edit-member/${userIdString}`);
    }
            ...
            <div className="max-w-3xl mx-auto bg-white md:shadow-lg">
                ...
                <div className="p-4">
                    ...
                    <div className="flex justify-start items-center mb-6">
                        <Image src="/profile.png" width={100} height={100} alt="Logo" className="w-24 h-24 rounded-full object-cover mb-2" />
