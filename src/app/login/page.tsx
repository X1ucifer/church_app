            ...
            <div className="w-full h-full max-w-7xl bg-white md:shadow-lg overflow-hidden flex flex-col md:flex-row">
                <div className="w-full md:w-1/2 bg-white-500 md:bg-purple-700 p-6 flex flex-col justify-between">
                    ...
                    <div className="hidden md:block">
                        <Image src="/church.png?height=400&width=400" width={400} height={400} alt="Church Building" className="mx-auto" />
                    </div>
                </div>

                <div className="w-full md:w-1/2 p-6 flex flex-col justify-center">
                    <div className="md:hidden mb-6">
                        <Image src="/church.png?height=200&width=200" width={400} height={400} alt="Church Building" className="mx-auto" />
                    </div>
